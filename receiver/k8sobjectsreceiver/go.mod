...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sinventory v0.156.0
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/k8sleaderelectortest v0.156.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/xk8stest v0.156.0
